...
public class SingleFileSourceConnectorConfig extends AbstractConfig {
    ...
    private static final String DIR_FILE_NAME_DEFEAULT_VALUE = "/tmp/kafka.txt";
    ...
    public static ConfigDef CONFIG = new ConfigDef()
            .define(
                DIR_FILE_NAME, ConfigDef.Type.STRING,
                DIR_FILE_NAME_DEFEAULT_VALUE, ConfigDef.Importance.HIGH,
                DIR_FILE_NAME_DOC)
            .define(
                    TOPIC_NAME, ConfigDef.Type.STRING,
